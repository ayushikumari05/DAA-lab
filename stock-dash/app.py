...
def update_data(n, val):  # inpur parameter(s)
    if n == None:
        return "Hey there! Please enter a legitimate stock code to get details.", "https://u.osu.edu/duska.7/files/2017/04/stock-market-3-21gyd1b.jpg", "Stocks", None, None, None
        # raise PreventUpdate
